        ...
        <form method="POST" action="{{ route('admin.staff.store') }}">
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" oninput="this.value=this.value.replace(/[^a-zA-ZğüşıöçĞÜŞİÖÇ\s]/g,'')" required>
                </div>
                <div class="form-group">
                    <label>E-posta</label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="tc_no" value="{{ old('tc_no') }}" maxlength="11" inputmode="numeric" oninput="this.value=this.value.replace(/[^0-9]/g,'')" required>
                    <span class="hint">Şifre olarak kullanılacak.</span>
                </div>
                <div class="form-group">
                    <label>Telefon</label>
                ...
                <div class="form-group">
                    ...
                    <select name="department" required>
                        ...
                        <option value="security" {{ old('department') == 'security' ? 'selected' : '' }}>Güvenlik</option>
                        <option value="kitchen" {{ old('department') == 'kitchen' ? 'selected' : '' }}>Yemekhane</option>
                        <option value="cleaning" {{ old('department') == 'cleaning' ? 'selected' : '' }}>Temizlik</option>
                    </select>
                </div>
                <div class="form-group">
