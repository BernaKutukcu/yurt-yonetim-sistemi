...
<div class="sidebar">
    <div class="sb-logo">
        ...
        <div class="sb-logo-sub">Personel Paneli</div>
    </div>
    <div class="sb-menu">
        <div class="sb-section">Genel</div>
        <a href="/staff/dashboard" class="sb-item {{ request()->is('staff/dashboard') ? 'active' : '' }}">
    ...
    <div class="sb-bottom">
        <div class="sb-user" onclick="toggleLogout()">
            <div class="sb-avatar">{{ mb_strtoupper(mb_substr(Auth::user()->name, 0, 1, 'UTF-8'), 'UTF-8') }}</div>
            <div>
                <div class="sb-uname">{{ Auth::user()->name }}</div>
                <div class="sb-urole">Personel</div>
            </div>
...
<script>
    setTimeout(function() {
        const flash = document.querySelector('.success');
